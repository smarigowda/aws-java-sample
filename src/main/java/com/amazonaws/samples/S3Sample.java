...
//            System.out.println();
            ...
            // list all the objects under bucket name nftresults
            System.out.println("Listing objects");

            ObjectListing objectListing2 = s3.listObjects(new ListObjectsRequest()
//                    .withBucketName("my-first-s3-bucket-d2f4e921-aec2-48e5-b811-edfed552f6f3"));
                    .withBucketName("nftresults")
                    .withPrefix("download/Result")
                    .withDelimiter("/"));

//            for (String commonPrefix : objectListing2.getCommonPrefixes()) {
//                System.out.println(commonPrefix);
//            }

            for (S3ObjectSummary objectSummary : objectListing2.getObjectSummaries()) {
                if (objectSummary.getKey().matches(".*Feb_10.*")) {
                    System.out.println(" - " + objectSummary.getKey() + "  " +
                            "(size = " + objectSummary.getSize() + ")");
                }
            }
